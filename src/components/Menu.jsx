    ...
    return (
        <nav className="w-full h-full flex flex-col justify-center items-center bg-blue-300">
            ...
            <div className="flex flex-col items-stretch max-w-md gap-2 my-4">
                <button className="bg-white rounded px-4 py-2 w-32" onClick={handlePlayClick}>Play</button>
                <button className="bg-white rounded px-4 py-2 w-32" onClick={handleCreditsClick}>Credits</button>
            </div>
